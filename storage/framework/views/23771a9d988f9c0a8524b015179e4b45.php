...
<?php $component->withAttributes([]); ?>
    <div class="mb-4 text-sm text-gray-600">
        <?php echo e(__('Lupa kata sandi Anda? Tidak masalah. Beri tahu kami alamat email Anda dan kami akan mengirimkan tautan reset kata sandi melalui email yang memungkinkan Anda membuat kata sandi baru.')); ?>
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between mt-4">
            <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-500 hover:text-gray-900 font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors">
                &larr; Kembali
            </a>
...
<?php endif; ?><?php /**PATH C:\Users\Dimas Rizky\cobacoba\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>